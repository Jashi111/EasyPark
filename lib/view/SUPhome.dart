...
class SupHomePage extends StatefulWidget {
  const SupHomePage({super.key});

  @override
  State<SupHomePage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<SupHomePage> {
...
// void _onMarkerTapped(BuildContext context, LatLng markerLocation, List<LatLng> parkingLocations) {
...
//     // Navigate to the PopUpMenu widget
//     Navigator.push(
//       context,
//       MaterialPageRoute(builder: (context) => const PopUpMenu()),
//     );
//   }
// }
